configs = {
    ...
    'trigout'         : 2,              # -1 no trigger output, 
                                        ...
                                        # line 2 has not isolation and takes 4-10us for on transition
    ...
    'serverfps'       : 30              # frame rate for display, usually we skip frames for display but record at full camera fps
    }
